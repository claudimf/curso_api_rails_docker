...
No arquivo API/spec/requests/contacts_spec.rb adicione:
```sh
...
[1° Include_json matcher](https://relishapp.com/waterlink/rspec-json-expectations/docs/json-expectations/include-json-matcher)  
[2° Setting request headers](https://relishapp.com/rspec/rspec-rails/docs/controller-specs/setting-request-headers)  
[3° Testing Array in rspec](https://tosbourn.com/testing-arrays-in-rspec/)  